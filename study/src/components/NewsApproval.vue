              ...
              >
                ...
                <tbody>
                  <tr v-for="d in data" :key="d" >
                    <td class="text-center text-muted">{{d.title}}</td>
                    ...
                    <td class="text-center">
                      <button
                        ...
                        v-on:click.prevent="Verify(d.id)"
                      >
...
export default {
    ...
    mounted () {
        // this.axios.get(config.hostname+'api/eventsinfo/Getbystatuspending/')
        //       .then((response) => {
    ...
    methods: {
        ...
        //     this.axios.put(config.hostname+'api/eventsinfo/Putupdatestatus/', {
